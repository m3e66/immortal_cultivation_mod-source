...
import com.example.immortal_cultivation_mod.item.YinhunGongArmorRenderer;
...
public class YinhunGongCurioRenderer implements ICurioRenderer {
    private final YinhunGongArmorRenderer armorRenderer = new YinhunGongArmorRenderer();
