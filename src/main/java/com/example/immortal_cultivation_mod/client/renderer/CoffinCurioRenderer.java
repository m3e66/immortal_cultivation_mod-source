...
import com.example.immortal_cultivation_mod.item.CoffinArmorRenderer;
...
public class CoffinCurioRenderer implements ICurioRenderer {
    private final CoffinArmorRenderer armorRenderer = new CoffinArmorRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext,
        ...
        if (renderLayerParent.getModel() instanceof HumanoidModel<?> humanoidModel) {
            ...
            if (entity.isShiftKeyDown()) {
                poseStack.mulPose(Axis.XP.rotationDegrees(11.0F));
            }
